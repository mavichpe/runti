...
var backend = {
    ...
    getPosts: function ($scope, tipo) {
        ...
        $.ajax({
            type: 'POST',
            async: false,
            url: this.url + 'posts/getPosts/' + tipo,
            data: data,
            dataType: 'json',
            success: function (data) {
                $scope.post = data;
...
//            }
    ...
    getEventosPorMes: function ($mes) {
        ...
        $.ajax({
            type: 'POST',
            async: false,
            url: this.url + 'events/getEventosPorMes/' + $mes,
            data: data,
            dataType: 'json',
            success: function (data) {
                events = data;
    ...
    getEventById: function (id) {
        ...
        $.ajax({
            type: 'POST',
            async: false,
            url: this.url + 'events/getEvento/' + id,
            data: data,
            dataType: 'json',
            success: function (data) {
                events = data;
